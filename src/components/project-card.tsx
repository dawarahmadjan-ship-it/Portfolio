        ...
        <div ref={cardRef} className="h-full">
            <GlassmorphismCard className="h-full group hover:shadow-2xl hover:shadow-blue-900/10 transition-shadow duration-500 flex flex-col">
                <div className="flex flex-col h-full p-5">
                    {/* Media Area */}
                    <div className={`relative overflow-hidden rounded-2xl ${project.category.includes("Shorts") ? 'aspect-[9/16]' : 'aspect-video'} mb-5 shadow-lg bg-black isolate`}>
                        <AnimatePresence mode="wait">
                            {isPlaying ? (
                                ...
                                >
                                    <iframe
                                        src={`https://www.youtube.com/embed/${project.id}?autoplay=1&mute=1&controls=1&rel=0&modestbranding=1`}
