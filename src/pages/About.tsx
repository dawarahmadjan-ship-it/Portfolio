              ...
              header={
                <div className="relative w-full h-full min-h-[28rem] md:min-h-[16rem] rounded-xl overflow-hidden group-hover/bento:scale-[1.02] transition-transform duration-500">
                  <img
                    src="/ahmadpic.jpg"
                    alt="Ahmad Dawar"
                    className="w-full h-full object-cover object-[center_75%] transition-all duration-500"
                  />
              ...
              header={
                <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-neutral-900 to-black border border-white/5 p-6 flex items-center">
                  ...
                  <p className="text-gray-300 italic text-sm md:text-base leading-relaxed relative z-10">
                    "I believe that editing is the heartbeat of a story. I don't just assemble shots; I find the perfect rhythm, emotion, and motion to create an experience that resonates long after the video ends."
                  </p>
                </div>
              }
              className="h-full"
            ...
            <BentoGridItem
              ...
              header={
                <div className="flex flex-1 h-full w-full items-center justify-between px-6 bg-gradient-to-r from-neutral-900 to-neutral-800 rounded-xl border border-white/5 py-4 md:py-0 min-h-[5rem]">
                  <a href="https://www.linkedin.com/in/ahmad-dawar-97ab57346/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-[#0077b5] hover:scale-110 transition-all duration-300 text-white"><Linkedin size={20} /></a>
                  <a href="https://www.instagram.com/a_dawar_7/" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-pink-600 hover:scale-110 transition-all duration-300 text-white"><Instagram size={20} /></a>
                  <a href="https://www.youtube.com/@ahmadsaadtwins2306" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-red-600 hover:scale-110 transition-all duration-300 text-white"><Youtube size={20} /></a>
                </div>
              }
              className="h-full"
