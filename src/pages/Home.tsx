        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 relative">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed whitespace-pre-line">
              From smooth transitions to precise audio syncing and dynamic animations.{"\n"}
              I focus on making your content not just polished, but <span className="text-blue-400 font-medium whitespace-nowrap">powerful</span>.
            </p>
          </div>
